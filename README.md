...
- `Infrastructure`: remote-node orchestration, background jobs, runtime stores, and cross-cutting services.
- `Data`: EF Core DbContext, migrations, entities, repositories, and runtime config-file utilities.
