...
нодами. Репозиторий `xrayne-panel` содержит только код панели: REST API и
...
```text
Api/             REST API и веб-хост
Infrastructure/  xray-core runtime, service implementations, background tasks, runtime utilities
Repositories/    EF Core, PostgreSQL repositories, migrations, external clients
Contracts/       DTO, configuration contracts, enums, shared values
Dashboard/       React-интерфейс
Test/            unit- и integration-тесты
```

## Работа с базой данных

Layer `Repositories` contains `AppDbContext`, EF Core repositories,
...
- Добавить проекты `Api`, `Cli`,
  `Infrastructure`, `Contracts`.
- Добавить React-приложение в `Dashboard`.
