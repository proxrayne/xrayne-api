...
{
    /// <inheritdoc />
    public partial class RemoveGeoResourceSourceTypeAndLastError : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<GeoResourceSourceType>(
                name: "SourceType",
                table: "GeoResources",
                type: "geo_resource_source_type",
                nullable: false,
                defaultValueSql: "'static'::geo_resource_source_type");

            migrationBuilder.Sql("""
                UPDATE "GeoResources"
                SET "SourceType" = 'auto_update'::geo_resource_source_type
