...
public interface IInboundRepository
{
    ...
    Task<List<InboundEntity>> GetAllAsync(long adminId, CancellationToken cancellationToken = default);
    ...
    Task<CursorPage<InboundEntity>> SearchAsync(long adminId, InboundFilter filter, CancellationToken cancellationToken = default);
    ...
    Task<InboundEntity?> GetByIdAsync(long adminId, long id, CancellationToken cancellationToken = default);
    ...
    Task<InboundEntity> AddAsync(long adminId, long nodeId, InboundEntity inbound, CancellationToken cancellationToken = default);

    Task<InboundEntity?> UpdateAsync(InboundEntity inbound, CancellationToken cancellationToken = default);

    Task<InboundEntity?> UpdateAsync(long adminId, InboundEntity inbound, CancellationToken cancellationToken = default);
